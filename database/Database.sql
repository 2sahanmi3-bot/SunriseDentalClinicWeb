...
SELECT *
FROM appointments
WHERE appointment_number = 'FE-SEARCH-001';
...
SELECT
    appointment_number,
    HEX(appointment_number),
    LENGTH(appointment_number)
FROM appointments;

UPDATE appointments
SET appointment_number = 'FE-SEARCH-001'
...
FROM appointments
WHERE appointment_number LIKE 'FE-%';
